...
![atomicity-violation](/assets/img/os_concurrency_problem/atomicity_violation.png){: width="60%" height="60%"}
...
![order-violation](/assets/img/os_concurrency_problem/order_violation.png){: width="60%" height="60%"}
...
![dead-ex1](/assets/img/os_concurrency_problem/dead_ex(1).png){: width="60%" height="60%"}
...
![dead-ex2](/assets/img/os_concurrency_problem/dead_ex(2).png){: width="35%" height="35%"}
...
![mutual-exlusion](/assets/img/os_concurrency_problem/mutual_exclusion.png){: width="40%" height="40%"}
![cas](/assets/img/os_concurrency_problem/compare_and_swap.png){: width="40%" height="40%"}
...
![hold-wait](/assets/img/os_concurrency_problem/hold_wait.png){: width="60%" height="60%"}
...
![trylock](/assets/img/os_concurrency_problem/trylock.png){: width="60%" height="60%"}
...
![partial](/assets/img/os_concurrency_problem/partial_ordering.png){: width="60%" height="60%"}
...
![lock-address](/assets/img/os_concurrency_problem/lock_address.png){: width="60%" height="60%"}
...
![dining](/assets/img/os_concurrency_problem/dining_philosophers.png){: width="60%" height="60%"}

이런 Dependency문제를 깨기 위해서 Dijkstra는 4명은 왼쪽 후 오른쪽, 나머지 한 명(P4)는 오른쪽 후 왼쪽을 가져가게끔 하였습니다. 

![dining-dijkstra](/assets/img/os_concurrency_problem/dining_dijkstra.png){: width="45%" height="45%"}
(주황색은 wait을 나타냄.)
...
![deadlock-scehduling](/assets/img/os_concurrency_problem/deadlock_scheduling.png){: width="60%" height="60%"}
...
![rag-ex](/assets/img/os_concurrency_problem/rag_ex.png){: width="60%" height="60%"}
...
![non-deadlock](/assets/img/os_concurrency_problem/non_deadlock.png){: width="60%" height="60%"}
...
![rag-deadlock](/assets/img/os_concurrency_problem/rag_deadlock.png){: width="60%" height="60%"}
